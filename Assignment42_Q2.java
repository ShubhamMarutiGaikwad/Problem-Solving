/*
Q: Write a java program which accept two array from user and display all even element of both array
Input Array 1: 2 9 6 5 2 3
Input Array 2: 45 6 12 18 23 4

Output of Array 1:  2 6 2
Output of Array 2: 6 12 18 4
*/
import java.util.*;
...
{   
    ...
    public void DisplayEven(int Arr1[],int Arr2[])
    {
        ...
        System.out.print("Even element of first array:");
        ...
        System.out.print("Even element of second array:");
...
{   
    ...
    mobj.DisplayEven(Array1,Array2);
    }
